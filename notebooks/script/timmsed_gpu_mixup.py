...
from src.models.timmsed import TimmSEDGPU, SelectiveTimmSEDGPU
...
def main():
    cfg = "../src/configs/timmsed/timmSED_exp_006.yaml"
    ...
    mixup_dataset = WaveformDatasetRating(mixup, cfg.model, mode="train")
...
#     )
    ...
    sed_model = SelectiveTimmSEDGPU(cfg.model)
